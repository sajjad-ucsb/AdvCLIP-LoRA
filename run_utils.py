...
def get_arguments():
    ...
    # parser.add_argument('--beta', default=10/255, type=float)
    # parser.add_argument('--epsilon', default=10/255, type=float)
    parser.add_argument('--robust', default='True', type=str)
    ...
    # parser.add_argument('--attack', default='False', type=str)
    # LoRA arguments
    ...
    parser.add_argument('--iters', help='Number of iters for PGD?', type=int, default=100)
    parser.add_argument('--epsilon', help='epsilon?', type=float, default=1.0)
    parser.add_argument('--epsilon_train', help='epsilon?', type=float, default=10.0)
